...
class AuthController extends Controller
{
    ...
    public function index()
    {
        ...
        $staff = (new \app\models\UserModel())->fetchWithRelation(['dep_id']);
...
//        returns an array of all the departments
    ...
    public function edit(Request $request)
    {
        ...
        $staffNdepartments = (new \app\models\UserModel())->fetchByIdWithRelation($request->getReqId(), ['dep_id']);
    ...
    public function update(Request $request)
    {
        ...
        $staff = (new \app\models\UserModel())->findById($request->getReqId());
...
//            'confirmPassword' => $staff->password,
    ...
    public function change_password(Request $request)
    {
        ...
        $staff = (new \app\models\UserModel())->findById($userId);
    ...
    public function delete(Request $request)
    {
        ...
        $staff_info = (new \app\models\UserModel())->findById($request->getReqId());
        /*

...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        $projectData = (new \app\models\ProjectModel)->fetchWithRelation(['dep_id', 'sub_id', 'year_id', 'staff_id']);
    ...
    public function create(Request $request)
    {
        ...
        $sub_counties = (new \app\models\SubCountyModel())->all();
        $departments = (new \app\models\DepartmentModel())->all();
        $f_years = (new \app\models\FinancialModel())->all();
        $staffs = (new \app\models\UserModel())->fetchWithRelationWhere(['user_type' => 'staff'], ['dep_id']);
    ...
    public function edit(Request $request)
    {
         ...
         */
        $projects = (new \app\models\ProjectModel)->fetchByIdWithRelation($request->getReqId(), ['dep_id', 'sub_id', 'year_id', 'staff_id']);
        ...
        return $this->render('../app/projects/project_edit', [
            'model' => [
                ...
                'sub_counties' => (new \app\models\SubCountyModel)->all(),
                'f_years' => (new \app\models\FinancialModel)->all(),
                'staffs' => (new \app\models\UserModel)->fetchWithRelation(['dep_id'])
            ]
        ]);
...
//        echo '</pre>';
    ...
    public function delete(Request $request)
    {
        ...
        $project_info = (new \app\models\ProjectModel)->findById($request->getReqId());
        /*
    ...
    public function pending()
    {
         ...
         */
        $this->setLayout('app');
        $projects = (new \app\models\ProjectModel)->fetchWithRelationWhere(['pr_status' => 'pending'], ['dep_id', 'sub_id', 'year_id', 'staff_id']);
    ...
    public function approved(Request $request)
    {
        ...
        $id = $request->getReqId();
        $approved_pr = (new \app\models\ProjectModel)->fetchByIdWithRelation($id, ['dep_id', 'sub_id', 'year_id', 'staff_id']);
    ...
    public function delay(Request $request)
    {
        ...
        //get all projects with Relation where id is the id that was posted in get body
        $id = $request->getReqId();
        $delayed_pr = (new \app\models\ProjectModel)->fetchByIdWithRelation($id, ['dep_id', 'sub_id', 'year_id', 'staff_id']);
        //new instance of model to get table properties
    ...
    public function projects_start(Request $request)
    {
        ...
        $ongoingProjects = (new \app\models\ProjectModel)->fetchWithRelationWhere(['pr_status' => 'approved'], ['dep_id', 'sub_id', 'year_id', 'staff_id']);

        //if an id exists in the get request, do this
        if($request->getReqId())
        {
            $id = $request->getReqId();
            $ongoing_pr = (new \app\models\ProjectModel)->fetchByIdWithRelation($id, ['dep_id', 'sub_id', 'year_id', 'staff_id']);
            //new instance of model to get table properties
    ...
    public function projects_manage()
    {
        ...
        $ongoingProjects = (new \app\models\ProjectModel)->fetchWithRelationWhere(['pr_status' => 'ongoing'], ['dep_id', 'sub_id', 'year_id', 'staff_id']);
        ...
        $staffProjects = (new \app\models\ProjectModel)->fetchWithRelationWhere(['staff_id' => $_SESSION['user']['id'], 'pr_status' => 'ongoing'], ['dep_id', 'sub_id', 'year_id', 'staff_id']);
    ...
    public function projects_showcase(Request $request)
    {
        ...
        $id = $request->getReqId();
        $ongoingProjects = (new \app\models\ProjectModel)->fetchByIdWithRelation($id, ['dep_id', 'sub_id', 'year_id', 'staff_id']);

        //We find all tasks where the project id is the id of the project being tracked and display in view
        $tasks = (new \app\models\TaskModel)->findAllWhere(['proj_id' => $id]);
    ...
    public function projects_complete(Request $request)
    {
        ...
        //get all projects with Relation where id is the id that was posted in get body
        $id = $request->getReqId();
        $completed_pr = (new \app\models\ProjectModel)->fetchByIdWithRelation($id, ['dep_id', 'sub_id', 'year_id', 'staff_id']);

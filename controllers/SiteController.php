...
class SiteController extends Controller
{
    ...
    public function guest(Request $request)
    {
        ...
        $projects = (new \app\models\ProjectModel)->fetchWithRelation(['dep_id', 'sub_id', 'year_id', 'staff_id']);
...
//        var_dump($search);
//        die();
        $results = (new \app\models\ProjectModel)->fetchBySearchWithRelation($search,['project_name', 'dep_name', 'sub_name'], ['dep_id', 'sub_id', 'year_id', 'staff_id']);
        ...
        return $this->render('home', [
            ...
            'counters' => [
                'completed' => (new \app\models\ProjectModel)->findAllWhere(['pr_status' => 'complete']),
                'approved' => (new \app\models\ProjectModel)->findAllWhere(['pr_status' => 'approved']),
                'pending' => (new \app\models\ProjectModel)->findAllWhere(['pr_status' => 'pending']),
                'ongoing' => (new \app\models\ProjectModel)->findAllWhere(['pr_status' => 'ongoing']),
                'delayed' => (new \app\models\ProjectModel)->findAllWhere(['pr_status' => 'delayed'])
...
//        var_dump($results);
    ...
    public function activity(Request $request)
    {
         ...
         */
        $activity = (new \app\models\ActivityModel)->fetchWithRelation(['staff_id', 'dep_id']);
        //fetch all staffs
        $staffs = (new \app\models\UserModel)->all();
...
//        var_dump($user);
        ...
        $filtered_activity = (new \app\models\ActivityModel)->fetchByFilterWithRelation($from_date, $to_date, ['staff_id' => $user], ['staff_id', 'dep_id']);
    ...
    public function reports(Request $request)
    {
        ...
        $filtered_reports = (new \app\models\ProjectModel)->fetchByFilterWithRelation($from_date, $to_date, ['pr_status' => $status], ['dep_id', 'sub_id', 'year_id', 'staff_id']);
